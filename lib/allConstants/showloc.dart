...
class Showloc extends StatefulWidget {
  final loc;

  Showloc({this.loc});

  @override
  _ShowlocState createState() => _ShowlocState();
}

class _ShowlocState extends State<Showloc> {
  ...
  void showlocation() async {
    getUserCurrentLocation().then(
      (value1) async {
        ...
        print(value1.latitude.toString() + " " + value1.longitude.toString());
        final GoogleMapController controller = await _controller.future;
        controller
